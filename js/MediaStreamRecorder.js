...
function MediaStreamRecorder(mediaStream) {
    ...
    this.stop = function(callback) {
        ...
        if (mediaRecorder) {
            console.log('heree');
            mediaRecorder.stop(callback, mediaRecorder.blobs);
        }
    };
...
function MediaRecorderWrapper(mediaStream) {
     ...
     * });
     */
    this.stop = function(callback, mediaRecorder_blob) {
        if (!mediaRecorder) {
            return;
        }
        ...
        if (mediaRecorder.state === 'recording' || mediaRecorder.state === 'paused') {
            ...
            setTimeout(function() {
                ...
                ConcatenateBlobs(mediaRecorder_blob, mediaRecorder_blob[0].type, function(concatenatedBlob) {
                    // console.log('concatenatedBlob=> ', concatenatedBlob);
                    callback(concatenatedBlob);
                });
                mediaRecorder = null;
                self.onstop();
